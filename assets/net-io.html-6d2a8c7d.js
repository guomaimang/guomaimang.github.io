import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-b56afac9.js";const p={},e=t(`<h1 id="java-简单网络通信-io" tabindex="-1"><a class="header-anchor" href="#java-简单网络通信-io" aria-hidden="true">#</a> Java 简单网络通信 IO</h1><h2 id="tcp-文本通信" tabindex="-1"><a class="header-anchor" href="#tcp-文本通信" aria-hidden="true">#</a> TCP 文本通信</h2><p>对于客户端</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span><span class="token punctuation">{</span>
