import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as l,c as t,a as e,b as n,d as i,e as c}from"./app-4075a7d1.js";const s={},o=c(`<h1 id="初识-c-中的-argc与argv" tabindex="-1"><a class="header-anchor" href="#初识-c-中的-argc与argv" aria-hidden="true">#</a> 初识 c++ 中的 argc与argv</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>在许多C ++ IDE和编译器中，当它为您生成main函数时，它看起来像这样：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>int main(int argc, char *argv[])
