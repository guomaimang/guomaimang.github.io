import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as a}from"./app-78c70878.js";const r={},l=a(`<h1 id="searching-algorithms" tabindex="-1"><a class="header-anchor" href="#searching-algorithms" aria-hidden="true">#</a> Searching Algorithms</h1><h2 id="goal" tabindex="-1"><a class="header-anchor" href="#goal" aria-hidden="true">#</a> Goal</h2><p>Given an array A of n numbers (in ascending order)</p><ul><li>Find the position of a key k from the array A</li><li>return –1 if not found</li></ul><p>A: | 1 | 3 | 8 | 12 | 17 | 23 | 35</p><h2 id="algorithm-1-linear-search" tabindex="-1"><a class="header-anchor" href="#algorithm-1-linear-search" aria-hidden="true">#</a> Algorithm 1: Linear search</h2><p>Assume k appears at most once in the array. Once k is found, the algorithm stops.</p><ul><li>Best Case: K is in the first element</li><li>Worse Case: K is in the last element; element not found</li><li>Average case: Half of the array is searched</li></ul><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>for(int i=0;i&lt;n;i++){
  if(A[i]==target){
    returni;
  }
else{
